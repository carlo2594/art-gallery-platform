...
module.exports = app => {
  ...
  app.use('/api/v1/purchase-inquiries', require('@routes/api/purchaseInquiryRoutes'));
  app.use('/api/v1/artist-applications', require('@routes/api/artistApplicationRoutes'));
